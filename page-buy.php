					...
					<div class="col-lg-6">
						<div class="home-intro-content">
											...
											<h3 class="h3-new">
												<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 10 10" style="enable-background:new 0 0 10 10;" xml:space="preserve">
													<g>
														...
														<path style="fill:#002C3F;" d="M5,0C2.243,0,0,2.243,0,5s2.243,5,5,5s5-2.243,5-5S7.757,0,5,0z M5,9C2.791,9,1,7.209,1,5c0-2.209,1.791-4,4-4s4,1.791,4,4C9,7.209,7.209,9,5,9z" />
													</g>
												</svg>
												<?php echo $title; ?>
											</h3>
							...
							<div class="buy-intro-btn">
								<a href="<?php echo $buy_btn_url; ?>" class="btn-cta btn-cta-reverse btn-wide">
