...
<?php
$sell_btn_url = get_field('sell_button_url');
$sell_btn_text = get_field('sell_button_text');
?>

<section class="sell-buttons">
<div class="container-sm">
<a href="<?php echo $sell_btn_url; ?>" class="btn-wide btn-cta btn-cta-reverse">
<span><?php echo $sell_btn_text; ?></span>
