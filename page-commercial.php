			...
			<div id="filters" class="form-col filters">
				...
				<div class="form-section">
					...
					<div class="form-section-content filter-size">
						<input type="text" name="size_min" id="size_min" placeholder="Min sqft" <?php if ( $load_size_min ) { echo 'value="' . $load_size_min . '"'; } ?> />
						<input type="text" name="size_max" id="size_max" placeholder="Max sqft" <?php if ( $load_size_max ) { echo 'value="' . $load_size_max . '"'; } ?> />
					</div>
				</div>
				...
				<div class="form-section">
					...
					<div class="form-section-content filter-keyword">
						...
						<!--<div class="search-result <?php //if ($load_search) { echo 'open'; } ?>"><span class="search-keyword">"<?php //if ($load_search) { echo $load_search; } ?>"</span><input type="button" id="search-reset" class="search-reset" value="X"></div>-->
					</div>
				</div>
