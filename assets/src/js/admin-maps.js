...
function initialize () {
	...
	/* Add commas to property admin input fields with number values on load and focus-out */
	// let numbers = document.querySelectorAll('.property-number-field input[type="text"]');
	// numbers.forEach(function(number) {
	// 	number.value = number.value.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
